  ...
  (() => {
    ...
    var t = {
              ...
              return function (h, d, g, y) {
                for (
                  var b,
                    ...
                    A = 0,
                    O = y || u,
                    E = e ? O(h, _) : r || f ? O(h, 0) : void 0;
                  _ > A;
                  A++
                )
                  if ((v || A in w) && ((m = S((b = w[A]), A, x)), t))
                    if (e) E[A] = m;
                    else if (m)
                      switch (t) {
                        case 3:
        ...
        1656: (t, e, r) => {
          ...
          t.exports = function (t, e, r, a, h, g, E) {
            ...
            if (
              ...
              if (
                ((C = { values: I(_), keys: g ? F : I(S), entries: I(A) }), E)
              )
        ...
        5112: (t, e, r) => {
          ...
          t.exports = function (t) {
            return (
              i(l, t) || (l[t] = c && i(s, t) ? s[t] : p("Symbol." + t)),
              l[t]
            );
          };
        },
                ...
                [
                  ...
                  function (t, n) {
                    ...
                    for (var m = 0, x = 0, A = []; x < a.length; ) {
                      ...
                      if (
                        null === C ||
                        (O = _(v(g.lastIndex + (w ? x : 0)), a.length)) === m
                      )
                        x = f(a, x, l);
                      else {
                        if ((E(A, j(a, m, x)), A.length === b)) return A;
                        for (var k = 1; k <= C.length - 1; k++)
                          if ((E(A, C[k]), A.length === b)) return A;
                        x = m = O;
                      }
                    }
                    return (E(A, j(a, m)), A);
        ...
        4032: (t, e, r) => {
          ...
          (s ||
            (j(
              (Y = (z = function () {
                if (f(Y, this)) throw X("Symbol is not a constructor");
                var t =
                ...
                return (
                  u && ot && it(W, e, { configurable: !0, set: r }),
                  at(e, t)
                );
              })[G]),
              "toString",
            ...
            u &&
              ...
              c || j(W, "propertyIsEnumerable", st, { unsafe: !0 }))),
            n(
        ...
        3948: (t, e, r) => {
          ...
          for (var v in o) f(n[v] && n[v].prototype, v);
          f(i, "DOMTokenList");
        },
      },
      e = {};
    ...
    return (
      (() => {
              ...
              switch (o) {
                ...
                case "hsva":
                  ...
                  if (
                    ...
                    break t;
                  return { values: [C, k, I, P], a: P, type: o };
              }
        ...
        /*! NanoPop 2.3.0 MIT | https://github.com/Simonwep/nanopop */ var k,
          I = {
          ...
          P = function (t, e, r) {
            var n =
              "object" != typeof t || t instanceof HTMLElement
                ? Object.assign({ reference: t, popper: e }, r)
                : t;
            return {
              update: function (t) {
                void 0 === t && (t = n);
                ...
                return (function (t, e, r) {
                  ...
                  return ((e.style.left = f), (e.style.top = v), null);
                })(r, o, n);
              },
            };
          };
