...
<div class="sidebar-contact ">
    ...
    <div class="themecard-body offcanvas-body">
        ...
        <div class="p-3 pt-0">
            <div class="row gx-3">
                <div class="col-12">
                    <a href="#" id="resetbutton" class="btn btn-primary close-theme w-100"><i class="ti ti-restore me-1"></i>Reset</a>
                </div>
            </div>
        </div>    
    </div>
